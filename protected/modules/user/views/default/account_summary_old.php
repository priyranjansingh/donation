                    ...
                    <div class="summarySection engagementMainBar row">
                        ...
                        <div id="js_engagementActions" class="col-sm-5 engagementActions">
                            <ul class="actionsContainer nemo_actionsContainer">
                                <li class="actionItem"><a href="<?php echo base_url() . "/user/donate/step1"; ?>" role="button" data-module-number="1" name="EM_SendMoney" data-pagename="main:walletweb:summary::main" data-pagename2="main:walletweb:summary::main:::" data-track-type="link" class="vx_small-text selectModule nemo_transferSelect js_selectModule animate"><span class="icon icon-medium icon-send-money" aria-hidden="true"></span><span>Donate Now</span></a></li>
                                <li class="actionItem"><a href="<?php echo base_url() . "/solicitor/search/step1"; ?>" target="_blank" role="button" data-pagename="main:walletweb:summary::main" data-pagename2="main:walletweb:summary::main:::" data-track-type="link" data-module-number="2" name="EM_DownloadApp" class="vx_small-text js_selectModule selectModule nemo_appSelect"><span class="icon icon-medium icon-calendar" aria-hidden="true"></span>Meshulach Search</a></li>
