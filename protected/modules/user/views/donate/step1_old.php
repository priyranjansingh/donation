...
<div class="container-fluid contents flexify" id="contents" role="main" aria-labelledby="heading1">
    <section class="mainContents row transfer  funnelPage_experiment_3 pageName-funnelPage pageName-recipientPage" id="transfer">
        <div id="transfer-page" class="fadeInUp">
            ...
            ?>
                <h2 class="txtCenter fade in" style="display: block;">Donate Funds</h2>
                <p class="header-copy fade in" style="display: block;">Please enter the Visit Code to donate funds.</p>
                        ...
                        <div class="recipient-input-row">
                            <div class="recipient-input-form-fields clearfix">
                                <div class="recipient-input-wrapper hideNext col-sm-9 col-xs-12">
                                    <div class="textInput tall recipient recipient recipient lap"><!-- <div class="textInput tall recipient recipient recipient lap hasError"></div>-->
                                        <label for="recipient"></label>
                                          <?php echo $form->error($model, 'visit_code'); ?>
                                          <?php echo $form->textField($model, 'visit_code', array('placeholder' => 'Visit Code','class'=>'hasHelp validate recipientInput')); ?>
