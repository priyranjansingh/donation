<section class="todo">
    <div class="ml-header relative clear">
        <div class="p-20">
            <h3 class="mdl-color-text--white m-t-20 m-b-5">Donate Funds</h3>
            <h4 class="mdl-color-text--indigo-100 m-b-20 no-m-t w100">Please enter the Visit Code to donate funds.</h4>
        </div>
    </div>
                                ...
                                <div class="form-actions wizard mgtp-20">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-12 text-center">
                                            <?php echo CHtml::submitButton('Submit', array("value"=>"Next","class" => "btn vd_btn next mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent button-full")); ?>
                                        </div>
                                    </div>
                                    <?php $this->endWidget(); ?>
                                </div>
