...
class Donation extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, visit_id, mobile, solicitor_id, amount, mode, payment_status, reference_number,short_note, status, deleted, created_by, modified_by, date_entered, date_modified', 'safe', 'on'=>'search'),
		);
	}
