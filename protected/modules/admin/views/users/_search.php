...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'notify_solicitor'); ?>
		<?php echo $form->textField($model,'notify_solicitor'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'credit_limits'); ?>
		<?php echo $form->textField($model,'credit_limits',array('size'=>16,'maxlength'=>16)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'mobile_verified'); ?>
		<?php echo $form->textField($model,'mobile_verified'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'phone_verified'); ?>
		<?php echo $form->textField($model,'phone_verified'); ?>
	</div>
