...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('solicitor_code')); ?>:</b>
	<?php echo CHtml::encode($data->solicitor_code); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_of_estd')); ?>:</b>
	<?php echo CHtml::encode($data->date_of_estd); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('freezed')); ?>:</b>
	<?php echo CHtml::encode($data->freezed); ?>
	<br />
