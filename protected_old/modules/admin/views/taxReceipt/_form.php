...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'receipt_number'); ?>
		<?php echo $form->textField($model,'receipt_number',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'receipt_number'); ?>
	</div>
