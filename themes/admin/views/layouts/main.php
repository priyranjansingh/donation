    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Donation</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url().'/admin/country'; ?>"><i class="fa fa-circle-o"></i> Countries</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url().'/admin/user/create'; ?>"><i class="fa fa-circle-o"></i> Add User</a></li>
                ...
                <li><a href="<?php echo base_url().'/admin/visit/create'; ?>"><i class="fa fa-circle-o"></i> Add Solicitor Visit</a></li>
                <li><a href="<?php echo base_url().'/admin/country/create'; ?>"><i class="fa fa-circle-o"></i> Add Country</a></li>
              </ul>
            </li>
          </ul>
        </section>
